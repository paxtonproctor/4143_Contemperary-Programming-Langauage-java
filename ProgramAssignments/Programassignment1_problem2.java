...
// 9/15/2021
/** Problem 2 takes a x array and creates a copy of it known as y array
 *  we then change the order of y array and descend it in order. next we take
 *  a average of y and then add it to y and put it in descended order and print it.
